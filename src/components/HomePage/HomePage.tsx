        ...
        <div className="col">
          <div className="card svg-card">
            ...
            <div className="card-body">
              ...
              <p className="card-text">Amazon CloudWatch monitors your Amazon Web Services (AWS) resources and the applications you run on AWS in real time.</p>
              <Link to="/aws">
        ...
        <div className="col">
          <div className="card svg-card">
            ...
            <div className="card-body">
              ...
              <p className="card-text">Azure Monitor supports your operations at scale by helping you maximize the performance and availability of your resources.</p>
              <Link to="/azure">
                <button type="button" className="btn btn-primary">View</button>
              </Link>
            </div>
        ...
        <div className="col">
          <div className="card svg-card">
            ...
            <div className="card-body">
              ...
              <p className="card-text">Integrated monitoring, logging, and trace managed services for applications and systems running on Google Cloud and beyond.</p>
              <Link to="/google">
                <button type="button" className="btn btn-primary">View</button>
              </Link>
            </div>
