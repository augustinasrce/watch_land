...
const AwsGroups = () => {
    ...
    useEffect(() => {
        // Example: 
        // const body = [
        //      [{"message":"Text", "isLink":true, "link":"/aws/1/"}, {"message":"Text 2", "isLink":false, "link":"/aws/2/"}],
        //      [{"message":"Text 3", "isLink":true, "link":"/aws/3/"}, {"message":"Text 4", "isLink":false, "link":"/aws/4/"}]
        // ]        
        const bodyCells = ()=>{
            return [ ...groups?.map((group:IAwsLogGroups)=>{
                const groupName = tableCellObject(group.logGroupName, true, slugifyString(group.logGroupName))    
